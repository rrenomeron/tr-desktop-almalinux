...
1. Build your image: `sudo just build` (see [`Justfile`](../../Justfile))
2. If on a bootc system: `sudo bootc switch --transport containers-storage localhost/tr-desktop-almalinux:localdev`
