# AlmaLinux Atomic Desktop Standard Operating Environment

This is an alternative 
[standard operating environment](https://www.redhat.com/en/topics/management/what-is-an-soe)
for my desktops and laptops based on AlmaLinux rather than Fedora.  It's designed to have many
of the same features as my [Fedora SOE](https://github.com/rrenomeron/tr-desktop-fedora), but
with an AlmaLinux base, for use cases where an Enterprise style operating system is needed.
